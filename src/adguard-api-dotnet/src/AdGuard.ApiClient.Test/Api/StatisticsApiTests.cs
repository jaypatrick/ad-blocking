...
namespace AdGuard.ApiClient.Test.Api
{
    ...
    public class StatisticsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test GetTimeQueriesStats
        /// </summary>
        [Fact]
        public void GetTimeQueriesStatsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //long timeFromMillis = null;
            //long timeToMillis = null;
            //var response = instance.GetTimeQueriesStats(timeFromMillis, timeToMillis);
            //Assert.IsType<TimeQueriesStatsList>(response);
        }
    }
}
