...
scripts\rules-compiler-shell\compile-rules.cmd

REM Use specific configuration
scripts\rules-compiler-shell\compile-rules.cmd -c config.json

REM Compile and copy to rules
scripts\rules-compiler-shell\compile-rules.cmd -c config.json -r

REM Show version
scripts\rules-compiler-shell\compile-rules.cmd -v
```
