...
```xml
<ItemGroup>
  <ProjectReference Include="path\to\src\adguard-api-dotnet\src\AdGuard.ApiClient\AdGuard.ApiClient.csproj" />
</ItemGroup>
```
...
```xml
<ItemGroup>
  <ProjectReference Include="..\..\src\adguard-api-dotnet\src\AdGuard.ApiClient\AdGuard.ApiClient.csproj" />
</ItemGroup>
```
